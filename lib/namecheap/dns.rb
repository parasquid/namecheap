module Namecheap
  class Dns < Api
    ...
    def set_default(sld, tld, options = {})
      options['SLD'] = sld
      options['TLD'] = tld
      api_call('domains.dns.setDefault', options)
    end
    ...
    def set_custom(sld, tld, nameservers = [], options = {})
      ...
      api_call('domains.dns.setCustom', options)
    end
    ...
    def get_list(sld, tld, options = {})
      options['SLD'] = sld
      options['TLD'] = tld
      api_call('domains.dns.getList', options)
    end
    ...
    def get_hosts(sld, tld, options = {})
      options['SLD'] = sld
      options['TLD'] = tld
      api_call('domains.dns.getHosts', options)
    end
    ...
    def get_email_forwarding(domain, options = {})
      ...
      api_call('domains.dns.getEmailForwarding', options)
    end
    ...
    def set_email_forwarding(domain, options = {})
      options['DomainName'] = domain
      api_call('domains.dns.setEmailForwarding', options)
    end
    ...
    def set_hosts(sld, tld, options = {})
      options['SLD'] = sld
      options['TLD'] = tld
      api_call('domains.dns.setHosts', options)
    end
  end
end
