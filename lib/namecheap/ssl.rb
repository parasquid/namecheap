module Namecheap
  class Ssl < Api
    ...
    def get_approver_email_list(domain, options = {})
      ...
      api_call('ssl.getApproverEmailList', options)
    end
    ...
    def resend_approver_email(id, options = {})
      options['CertificateID'] = id
      api_call('ssl.resendApproverEmail', options)
    end
    ...
    def resend_fulfillment_email(id, options = {})
      options['CertificateID'] = id
      api_call('ssl.resendfulfillmentemail', options)
    end
